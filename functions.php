<?php 
function koneksi() {
  $conn = mysqli_connect('localhost', 'root', '', 'db_katalog-buku') or die('koneksi DB gagal!');
  return $conn;
}
...
function tambah($data) {
  ...
  $tahun = mysqli_real_escape_string($conn, htmlspecialchars($data['tahun']));
  ...
  $query = "INSERT INTO buku
              VALUES (null, '$judul', '$penulis', '$penerbit', '$tahun','$kategori', '$gambar')";
