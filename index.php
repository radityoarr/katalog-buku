          ...
          <div class="col-md-4 col-sm-6">
            <div class="card mb-3">
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    <span class="position-absolute top-0 end-0 bg-dark text-white py-1 px-1 opacity-75 text-capitalize"><small><?= $b['kategori']; ?></small></span>
                    <h5 class="card-title"><?= $b['judul']; ?></h5>
                    <p class="card-text text-muted m-0"><?= $b['penulis']; ?></p>
                    <p class="card-text"><small><?= $b['penerbit']; ?></small></p>
                    <p class="card-text"><small><?= $b['tahun']; ?></small></p>
